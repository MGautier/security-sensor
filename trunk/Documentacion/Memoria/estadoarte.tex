...
\begin{itemize}
  ...
  \item configparser 3.5.0: \url{https://docs.python.org/2/library/configparser.html} - Es módulo o clase que implementa un lenguaje muy sencillo para el parseo de archivos de configuración, siguiendo una estructura similar a como se describen y procesan los archivos INI en sistemas Microsoft Windows.
\end{itemize}
