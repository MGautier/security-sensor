...
\newpage
\begin{figure}[H]
  \hspace*{0.65in}{\includegraphics[scale=0.47]{diagramas/visualization.png}}
...
\begin{minipage}{\linewidth}
  ...
  \begin{figure}[H]
    \vspace*{-.1in}{\hspace*{.35in}{\includegraphics[scale=.7]{diagramas/vista-principal.jpg}}}
...
\begin{figure}[H]
\vspace*{-.1in}{\hspace*{.65in}{\includegraphics[scale=.7]{diagramas/vista-live-events.jpg}}}
...
\begin{figure}[H]
\vspace*{-.1in}{\hspace*{.75in}{\includegraphics[scale=.7]{diagramas/vista-estadisticas.jpg}}}
